    ...
    <input type="submit" name="button" id="button" value="Submit" />
            ...
            <section class="question7">
                ...
                <select name="choix7" class="choix7">
                    ...
                    <option name="item20" value="item20">
                        if...
                        while...
                        elif...
                    </option>
